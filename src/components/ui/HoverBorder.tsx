...
export function HoverBorder<C extends React.ElementType = "div">({
  children,
  containerClassName,
  as,
  ...props
}: PolymorphicComponentProp<C, HoverBorderProps>) {
...
export function HoverBorderGradient<C extends React.ElementType = "button">({
  ...
  clockwise = true,
  ...props
}: PolymorphicComponentProp<C, HoverBorderGradientProps>) {
